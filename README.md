...
- [ ] [改善]月次レポーティングのブラッシュアップ対応 #43
  - 修正点を洗い出したら記載する。
- [ ] [改善]YouTube 週次戦略レポートに週間CTRランキングを追加 #45
  - 現状の課題：CTRが極端に低い(1.5%程度)ことによるインプレッションが絞られている
  - 対策：サムネイルの改善対応を試し中の為、週間でのCTRがどの程度になっているか？を可視化して週次で比較できるようにする
  - 再生数ランキング上位の３つに再生数、いいね数の２つがあるがここにCTRも追加する
