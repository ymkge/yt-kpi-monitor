...
- [ ] [調査]デイリーレポートの前日比の再生数が+0になってることが多いので、実行時間をずらした方がよさそう #42
  - youtube側のデータ更新のタイミングに合わせて前日比がちゃんと見れるようにしたい
  - まずは更新タイミングが何時ごろなのか？などを整理するところから
    - 推奨：17:00 〜 21:00（JST） 【UTC 8:00 〜 12:00】
    - YouTube Analytics APIのデータ更新や、Data API側の前日分データの同期がほぼ確実に完了している時間帯。